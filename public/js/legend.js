//From users/kongdd/public:pkg_vis.js
//It has been modified
// var pkg_vis   = require('users/seibertli602/units/js/legend.js');
...
function grad_legend(viz, title, IsPlot, position) {
    ...
    var legend = ui.Panel({ style:{position: 'bottom-left',width: '100%'} });
    var legendTitle = ui.Label({
        value: title,
        style: {fontWeight: 'bold',position: 'bottom-center', margin: '0 auto',fontSize:'12px',padding:'0 2px'
        }
    });
    ...
    var panel_max = ui.Panel({
        ...
        style: { fontWeight: 'bold',position: 'bottom-center', margin: '0 auto',fontSize: '14px' }
    });
    ...
    var thumbnail = ui.Thumbnail({
        ...
        params: { 
          ...
          dimensions: '20x200' },
        style: { position: 'bottom-center', margin: '0 auto',border:'0.5px solid black' }
    });
...
function add_lgds(lgds, map) {
    ...
    lgds = ui.Panel({
        widgets: lgds,
        layout: ui.Panel.Layout.Flow('horizontal'),
        style: { fontSize: '14px', margin: '0 0 0px 0', padding: '0 0 0 0px', position: 'bottom-left' }
    });
    map.add(lgds);
